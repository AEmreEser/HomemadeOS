...
// PORTSIZE 32 bits
unsigned int volatile inline read_dbl_word(const unsigned int const port)  {
    unsigned int result;
...
// PORTSIZE 32 bits
void volatile inline write_dbl_word(const unsigned int const port, const unsigned int data)  {
